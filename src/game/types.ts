...
export type GameResult = GameLaunch & { id: string; sessionId: string; outcome: 'won' | 'lost'; penaltySeconds?: number; rewardedContinueUsed?: boolean; failureReason?: 'timeout'; mistakes: number; hintsUsed: number; elapsedMs: number; completedAt: string };
