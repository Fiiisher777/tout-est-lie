...
export type GameResult = GameLaunch & { id: string; sessionId: string; outcome: 'won' | 'lost'; failureReason?: 'timeout'; mistakes: number; hintsUsed: number; elapsedMs: number; completedAt: string };
