...
import { testerPacks } from './content/tester';
...
export const packs: Pack[] = isTester ? testerPacks(production) : __DEV__ && process.env.EXPO_PUBLIC_PUZZLE_CONTENT !== 'production'
  ? loadDevelopment()
