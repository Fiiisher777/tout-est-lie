export const en = {
  observationsRecorded: '%{count} observations recorded',
  ...
  observationArchived: "Observation recorded",
  observationInterrupted: "Observation interrupted",
  archiveComplete: "Everything is recorded for now.",
  recapUnavailable: "The connections for this observation are no longer available.",
